...
/**
 * NumberCruncherClient is a simple client for factoring integers. A remote
 * NumberCruncher is contacted and asked to factor an integer. The factors
 * returned by the {@link NumberCruncherServer} are displayed on the screen.
 * 
 * <p>
 * See <a href=doc-files/NumberCruncherClient.java>source</a> code of
...
public class NumberCruncherClient {
	...
	static void usage(String msg) {
		...
		System.err
				.println("Usage: java org.apache.log4j.examples.NumberCruncherClient HOST\n"
						+ "   where HOST is the machine where the NumberCruncherServer is running.");
		System.exit(1);
	}
