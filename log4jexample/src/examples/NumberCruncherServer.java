...
/**
 * A simple {@link NumberCruncher} implementation that logs its progress when
 * factoring numbers. The purpose of the whole exercise is to show the use of
 * nested diagnostic contexts in order to distinguish the log output from
 ...
 * 
 * <p>
 * Try it yourself by starting a <code>NumberCruncherServer</code> and make
 * queries from multiple {@link NumberCruncherClient NumberCruncherClients} to
 * factor numbers.
 * 
 * 
 * <p>
 * <b><a href="doc-files/factor.html">Sample output</a></b> shows the log output
 * when two clients connect to the server near simultaneously.
 * 
 * <p>
 * See <a href=doc-files/NumberCruncherServer.java>source</a> code of
 * <code>NumberCruncherServer</code> for more details.
 * 
 * <p>
 * Note that class files for the example code is not included in any of the
 * distributed log4j jar files. You will have to add the directory
 * <code>/dir-where-you-unpacked-log4j/classes</code> to your classpath before
...
public class NumberCruncherServer extends UnicastRemoteObject implements
	...
	public int[] factor(int number) throws RemoteException {
		...
		// distinctive information. It might reveal the users name, date of
		// request,
		...
		// Before leaving a thread we call NDC.remove. This deletes the
		// reference
		...
		// exiting a thread. See the java documentation in NDC.remove for
		// further
		// details.
		NDC.remove();
	...
	static void usage(String msg) {
		...
		System.err
				.println("Usage: java org.apache.log4j.examples.NumberCruncherServer configFile\n"
