...
/**
 * View the <a href="doc-files/Trivial.java">source code</a> of this a trivial
 * usage example. Running <code>java examples.Trivial</code> should output
 ...
 * 
 * <p>
 * The increasing numbers at the beginning of each line are the times elapsed
 * since the start of the program. The string between the parentheses is the
 ...
 * 
 * <p>
 * Note thent class files for the example code is not included in any of the
