 ...
 * {@link examples.SortAlgo SortAlgo} class.
 * 
 * <p>
 * This program expects a configuration file name as its first argument, and the
 * size of the array to sort as the second and last argument. See its <b><a
 * href="doc-files/Sort.java">source code</a></b> for more details.
 * 
 * <p>
 * Play around with different values in the configuration file and watch the
 * changing behavior.
 * 
 * <p>
 * Example configuration files can be found in <a
 ...
 * 
 * <p>
 * If you are also interested in logging performance, then have look at the
 * {@link org.apache.log4j.performance.Logging} class.
 * 
